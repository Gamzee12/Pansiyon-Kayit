...
namespace proje2
{
    public partial class FrmMusteriler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source = LAPTOP - 01UGQQIKSQLEXPRESS; Initial Catalog = Keskin Pansiyon; Integrated Security = True ");
        ...
        private void listView1_dexChanged(object sender, EventArgs e)
        {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update MusteriEkle set Adi ='" + TxtAdi.Text + "',Soyadı ='" + TxtSoyadı.Text + "',Cinsiyet='" + comboBox1.Text + "',Telefon='" + MskTxtTelefon.Text + "'.Mail='" + TxtMail.Text + "',TC='" + TxtKimlikNo.Text + "',OdaNo='" + TxtOdaNo.Text + "',Ucret ='" + TxtUcret.Text + "',GirisTarihi='" + DtpGirisTarihi.Value.ToString("yy-MM-dd") + "',CikisTarihi='" + DtpCikisTarihi.Value.ToString("yy-MM-dd") + "'where Musteriid" + id + "", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            verilergoster();
        }
...
//Data Source = LAPTOP - 01UGQQIK\SQLEXPRESS; Initial Catalog = "Keskin Pansiyon"; Integrated Security = True; Encrypt = True; Trust Server Certificate=True
