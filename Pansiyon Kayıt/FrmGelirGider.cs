...
namespace proje2
{
    public partial class FrmGelirGider : Form
    {
        ...
        private void FrmGelirGider_Load(object sender, EventArgs e)
        {
            ...
            while (oku4.Read()) 
            {
                LblFaturalar2.Text = oku4["toplam5"].ToString();
            }
            baglanti.Close();
        ...
        {
            int personel;
            personel = Convert.ToUInt16(textBox1.Text);
            LblPersonelMaas.Text = (personel * 1500).ToString();

            int sonuc;
            sonuc = Convert.ToInt32(LblKasaToplam.Text) - (Convert.ToInt32(LblPersonelMaas.Text) + Convert.ToInt32(LblAlinanUrunler1) + Convert.ToInt32(LblAlinanUrunler2.Text) + Convert.ToInt32(LblAlinanUrunler3.Text) + Convert.ToInt32(LblFaturalar1.Text) + Convert.ToInt32(LblFaturalar2.Text) + Convert.ToInt32(LblFaturalar3.Text));
