...
namespace proje2
{
    public partial class FrmOdalar : Form
    {
        ...
        private void FrmOdalar_Load(object sender, EventArgs e)
        {
            ...
            while (oku2.Read())
            {
                BtnOda102.Text = oku2["Adi"].ToString() + " " + oku1["Soyadı"].ToString();
            }
            baglanti.Close();
            ...
            while (oku4.Read())
            {
                BtnOda104.Text = oku4["Adi"].ToString() + " " + oku1["Soyadı"].ToString();
            }
            baglanti.Close();
            ...
            while (oku5.Read())
            {
                BtnOda105.Text = oku1["Adi"].ToString() + " " + oku5["Soyadı"].ToString();
            }
            baglanti.Close();
            ...
            while (oku8.Read())
            {
                BtnOda108.Text = oku8["Adi"].ToString() + " " + oku8["Soyadı"].ToString();
            }
            baglanti.Close();
